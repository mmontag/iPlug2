...
static void GetHostNameStr(EHost host, WDL_String& str)
{
  switch (host)
  {
      ...
      case kHostSonar:              str.Set("Sonar");               break;
      case kHostVegas:              str.Set("Vegas");               break;
      case kHostFL:                 str.Set("FL Studio");           break;
      case kHostSamplitude:         str.Set("Samplitude");          break;
      case kHostAbletonLive:        str.Set("Ableton Live");        break;
      case kHostTracktion:          str.Set("Tracktion");           break;
      case kHostNTracks:            str.Set("NTracks");             break;
      case kHostMelodyneStudio:     str.Set("Melodyne Studio");     break;
      case kHostVSTScanner:         str.Set("VST-Scanner");         break;
      ...
      case kHostDigitalPerformer:   str.Set("Digital Performer");   break;
      case kHostAudioMulch:         str.Set("AudioMulch");          break;
      case kHostStudioOne:          str.Set("Studio One");          break;
      ...
      case kHostGoldWave5x:         str.Set("GoldWave");            break;
