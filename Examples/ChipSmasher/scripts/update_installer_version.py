...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ChipSmasher Demo Installer\n"
      else:
        line="OutputBaseFilename=ChipSmasher Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ChipSmasher Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ChipSmasher installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ChipSmasher Demo installer\n"
     else:
       line="SetupWindowTitle=ChipSmasher installer\n"
