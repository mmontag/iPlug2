...
def main():
  ...
  plistpath = scriptpath + "/resources/ChipSmasher-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ChipSmasher-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ChipSmasher-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ChipSmasher-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ChipSmasher-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/ChipSmasher.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ChipSmasher.iss",inplace=1):
